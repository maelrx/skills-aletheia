# Standalone Prompt — 09-ai-generated-project-triage
...
Audit the current repository using the `09-ai-generated-project-triage` methodology. If patching is allowed by the user, make minimal safe changes and verify them. If patching is not explicitly allowed, perform a read-only audit and produce a remediation plan.
